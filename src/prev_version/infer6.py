...
class BindingCF(nn.Module):
    ...
    def __init__(self):
        ...
        self.lconv1_1 = nn.Conv1d(1, 27, 9)
        self.lconv1_2 = nn.Conv1d(1, 1, 3)

        self.lconv2_1 = nn.Conv1d(1, 27, 27)
        self.lconv2_2 = nn.Conv1d(1, 1, 9)

        self.lconv3_1 = nn.Conv1d(1, 27, 81)
        self.lconv3_2 = nn.Conv1d(1, 1, 27)
        self.lconv4_1 = nn.Conv1d(1, 27, 243)
...
PATH_model = '/home/jy2/practice/pytorch/model_save/model6.pt'
PATH_valdata = '/home/jy2/practice/pytorch/model_save/data_val_6.pt'
