...
class BindingCF(nn.Module):
    ...
    def __init__(self):
        ...
        self.pconv1_1 = nn.Conv1d(1, 1, 9) 
        self.pconv1_2 = nn.Conv1d(1, 1, 3)

        self.pconv2_1 = nn.Conv1d(1, 1, 27)
        self.pconv2_2 = nn.Conv1d(1, 1, 9)

        self.pconv3_1 = nn.Conv1d(1, 1, 81)
        self.pconv3_2 = nn.Conv1d(1, 1, 27)

        self.pconv4_1 = nn.Conv1d(1, 1, 243)
        self.pconv4_2 = nn.Conv1d(1, 1, 81)

        self.lconv1_1 = nn.Conv1d(1, 1, 9)
        self.lconv1_2 = nn.Conv1d(1, 1, 3)

        self.lconv2_1 = nn.Conv1d(1, 1, 27)
        self.lconv2_2 = nn.Conv1d(1, 1, 9)

        self.lconv3_1 = nn.Conv1d(1, 1, 81)
        self.lconv3_2 = nn.Conv1d(1, 1, 27)
        self.lconv4_1 = nn.Conv1d(1, 1, 243)
        self.lconv4_2 = nn.Conv1d(1, 1, 81)
...
PATH_model = '/home/jy2/practice/pytorch/model_save/model4.pt'
PATH_valdata = '/home/jy2/practice/pytorch/model_save/data_val_4.pt'

binding_cf = BindingCF()
binding_cf.load_state_dict(torch.load(PATH_model), strict = False)
binding_cf.eval()
