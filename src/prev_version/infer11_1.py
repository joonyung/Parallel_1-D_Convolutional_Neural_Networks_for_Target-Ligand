...
PATH_model = '/home/jy2/practice/pytorch/model_save/model11.pt'
PATH_valdata = '/home/jy2/practice/pytorch/model_save/data_val_11.pt'
...
with torch.no_grad():
    ...
    for i, (pro_val, lig_val, label_val) in enumerate(validationloader):
        ...
        outputs = preds.round()
        print(preds[0][0][0])
        print(type(preds[0][0][0]))
        label_score.append(preds[0][0][0])
...
with open("roc_label_true_11_1.txt", "wb") as path_true:
    pickle.dump(label_true, path_true)
with open("roc_label_score_11_1.txt", "wb") as path_score:
