...
validationloader = DataLoader(validation_dataset, batch_size = 16, shuffle =True)


#validation_data_saving
torch.save(validationloader, '/home/jy2/practice/pytorch/model_save/data_val_10.pt')
...
#saving model
PATH = '/home/jy2/practice/pytorch/model_save/model10.pt'
