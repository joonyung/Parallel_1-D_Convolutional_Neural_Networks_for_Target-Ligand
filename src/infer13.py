...
PATH_model = '/home/jy2/practice/pytorch/model_save/model13.pt'
PATH_valdata = '/home/jy2/practice/pytorch/model_save/data_val_13.pt'
...
with open("roc_label_true_13.txt", "wb") as path_true:
    pickle.dump(label_true, path_true)
with open("roc_label_score_13.txt", "wb") as path_score:
