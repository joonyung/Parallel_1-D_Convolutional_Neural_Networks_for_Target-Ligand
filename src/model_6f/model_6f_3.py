...
#train/val division
with open("/home/jy2/practice/pytorch/data_split/trainset3_after_helper.txt", "rb") as path_train:
    train_set_helper = pickle.load(path_train)
with open("/home/jy2/practice/pytorch/data_split/valset3_after_helper.txt", "rb") as path_val:
...
torch.save(validationloader, '/home/jy2/practice/pytorch/model_save/data_val_6f_3.pt')
...
#saving model
PATH = '/home/jy2/practice/pytorch/model_save/model_6f_3.pt'
