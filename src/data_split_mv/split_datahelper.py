...
protein_seq = open('/home/jy2/practice/pytorch/data_split/seq_train_list_5').read().splitlines()
...
#data_save as file
with open("trainset5_after_helper.txt", "wb") as path_file:
    pickle.dump(data_set, path_file)
