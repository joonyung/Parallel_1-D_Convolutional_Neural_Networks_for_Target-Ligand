...
PATH_model = '/home/jy2/practice/pytorch/model_save/model_6f_5.pt'
PATH_valdata = '/home/jy2/practice/pytorch/model_save/data_val_6f_5.pt'
...
with open("roc_label_true_6f_5.txt", "wb") as path_true:
    pickle.dump(label_true, path_true)
with open("roc_label_score_6f_5.txt", "wb") as path_score:
