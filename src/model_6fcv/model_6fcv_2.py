...
#train/val division
with open("/home/jy2/practice/pytorch/data_split/trainset2_after_helper.txt", "rb") as path_train:
    train_set_helper = pickle.load(path_train)
with open("/home/jy2/practice/pytorch/data_split/valset2_after_helper.txt", "rb") as path_val:
    val_set_helper = pickle.load(path_val)

train_set_pro = []
train_set_lig = []
train_set_label = []

for i, (data_pro, data_lig, data_label) in enumerate(train_set_helper):
    train_set_pro.append(data_pro)
    train_set_lig.append(data_lig)
    train_set_label.append(data_label)

train_dataset = BCFdata(train_set_pro, train_set_lig, train_set_label)
...
for i, (data_pro, data_lig, data_label) in enumerate(val_set_helper):
    val_set_pro.append(data_pro)
    val_set_lig.append(data_lig)
    val_set_label.append(data_label)

validation_dataset = BCFdata(val_set_pro, val_set_lig, val_set_label)
...
torch.save(validationloader, '/home/jy2/practice/pytorch/model_save/data_val_6fcv_2.pt')
...
#saving model
PATH = '/home/jy2/practice/pytorch/model_save/model_6fcv_2.pt'
