...
#train/val division
with open("/home/jy2/practice/pytorch/data_split/trainset0_after_helper.txt", "rb") as path_train:
    train_set_helper = pickle.load(path_train)
with open("/home/jy2/practice/pytorch/data_split/valset0_after_helper.txt", "rb") as path_val:
...
torch.save(validationloader, '/home/jy2/practice/pytorch/model_save/data_val_6fcv_0.pt')
...
#saving model
PATH = '/home/jy2/practice/pytorch/model_save/model_6fcv_0.pt'
